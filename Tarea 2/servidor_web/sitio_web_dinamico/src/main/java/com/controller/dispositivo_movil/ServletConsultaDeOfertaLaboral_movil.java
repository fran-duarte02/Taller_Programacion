...
public class ServletConsultaDeOfertaLaboral_movil extends HttpServlet {
    ...
    protected void cargarDatos(HttpServletRequest request, HttpServletResponse response)
		...
		//------------------------------------------------------------
			...
			boolean banderaPostulante = usr instanceof DataPostulante;
			...
			if(!banderaSesion || !banderaPostulante) { //mandamos a pagina de error, el caso de uso es solo accesible para postulantes
