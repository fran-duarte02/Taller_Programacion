...
<html lang="es">
  ...
  <head>
    ...
    <title>TrabajoUY : Error para Modificar el usuario</title>
  </head>
  <body>
    
    
    <%
    EstadoSesion sesion = (EstadoSesion) request.getSession().getAttribute("estadoSesion");
    if( sesion == EstadoSesion.SI_LOGEADO) {
    %>
    ...
    %>
	    ...
	    <div class = "contenedor2">
	  		<div class="alert alert-danger" role="alert">
	  				...
	  				<hr>
  					<strong>PARA MODIFICAR UN USUARIO DEBES TENER LA SESION INICIADA</strong>
  					<br>
  					<br>
