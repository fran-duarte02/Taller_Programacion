...
<head>
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <title>TrabajoUY : Consutlar Empresa</title>
  </head>
<body>
	    <header>
	...
	<nav class="navbar bg-dark px-5">
      ...
      <!--Content ends-->
			    ...
			    <div class="col-md-4 mb-4">
			      <div class="card" style="width: 18rem;">
			        ...
			        <div class="card-body">
			          ...
			          <a href="/TrabajoUY/iniciarSesion" class="btn btn-outline-dark">Postularme</a>
			        </div>
			      </div>
			    </div>
    	...
    	<div class = "texto-of ">
	     <h2>Seguidores de este usuario</h2>
	      </div>
    	...
    	<div class = "texto-of ">
	     <h2>Seguidos de este usuario</h2>
	      </div>
