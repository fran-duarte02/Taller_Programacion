...
public class KeyWord {
    ...
    protected KeyWord.Ofertas ofertas;
     ...
     * @return
     *     possible object is
     *     {@link KeyWord.Ofertas }
     *     
     */
    public KeyWord.Ofertas getOfertas() {
        return ofertas;
    }
     ...
     *     
     */
    public void setOfertas(KeyWord.Ofertas value) {
        this.ofertas = value;
    }
    ...
    public static class Ofertas {
        ...
        protected List<KeyWord.Ofertas.Entry> entry;
         ...
         * {@link KeyWord.Ofertas.Entry }
         * 
         * 
         * @return
         *     The value of the entry property.
         */
        public List<KeyWord.Ofertas.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<>();
            }
            return this.entry;
