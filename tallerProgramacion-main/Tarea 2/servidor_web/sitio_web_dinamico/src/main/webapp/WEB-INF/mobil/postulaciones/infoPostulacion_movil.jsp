			...
			<div class="col-12 col-md-4">
				<div class="alinearImg3">
					...
					<img src="data:image/jpeg;base64, <%=base64Image%>"
						align="absmiddle" class="img-thumbnail shadow" alt="...">

				</div>
			</div>
			<div class="col-md-8">
				<div class="contenedor4">
					<h2 class="text-uppercase fs-4 fw-bolder">Información de la
						postulacion</h2>
				</div>
				<!--cargo datos-->
				<div class="contenedor4">
					...
					<div class="row">
						...
						%>
						<div class="col">
						<button id="abrirVideoBtn" class="btn btn-dark col-12 py-3 col-md:4">Ver video</button></div>
						<%
						} else {
						%>
						<div class="col">
							<h4 class="fs-5 fw-lighter">No tiene video asociado a la
								postulación o envió un link incorrecto.</h4>
						</div>
						<%
						}
						%>
					...
					<div
						id="videoContainer"
						class="d-none position-fixed top-50 start-50 bg-dark h-100 translate-middle w-100"
